...
|-|-|
|![aa](Theme/Light/Standard/preview.png)|![bb](Theme/Light/Website%20Dots/preview.png)|
||Dots from the iiSU website, isolated and put into background form.|

|Dark Mode|Web. Dark Dots|
|-|-|
|![cc](Theme/Dark/Standard/preview.png)|![dd](Theme/Dark/Website%20Dots/preview.png)|
|A dark theme. Partially illuminated.|The original dark mode. A lot darker than the base version.|

|Decorated Theme|
|-|
|![ee](Theme/Dark/Decorated/preview.png)|
